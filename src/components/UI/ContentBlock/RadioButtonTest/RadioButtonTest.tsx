...
import {selectCoursesSelector, selectCurrentPage, selectRadioButtonIsCheckedSelector} from '@src/redux/courses/courses.selector';
...
export const RadioButtonTest = ({content, blockIndex}: RadioButtonTestProps) => {
    ...
    //без вызова селектора не работает вывод сообщения Верно/Неверно
    const radioButtonIsChecked = useSelector(selectRadioButtonIsCheckedSelector);
    ...
    useEffect(()=>{
        ...
        console.log('radioButtonIsChecked', radioButtonIsChecked);
